...
//        nodes.add(binaryTree.insert(8, bt));
        ...
        System.out.println("Height of Tree: " + binaryTree.height(bt));
        System.out.println("diameter of Tree: " + binaryTree.diameter(bt));
        ...
        System.out.println("LCA of " + alpha.getData() + "and " + beta.getData() + " Tree: " + (lca != null ? lca.getData() : null));
        System.out.println("Level of " + beta.getData() + " Tree: " + binaryTree.level(bt, beta));
        System.out.println("Distance between " + alpha.getData() + "and " + beta.getData() + " Tree: " + distance);
