 ...
 * Description:
 * <p>
 * Given a Binary Tree, return its Bottom View. The Bottom View of a Binary Tree
 * is the set of nodes visible when we see the tree from the bottom
 * File reference
 * -----------
 * Duplicate {@link}
 * Similar {@link BinaryTreeRightSideView_199} {@link BinaryTreeLeftSideView}
 * {@link BinaryTreeTopView}
...
public class BinaryTreeBottomView {
    ...
    public static void main(String[] args) {
        ...
        test &= test(new Integer[] { 1, 2, 3, 4, 10, 9, 11, null, 5, null, null, null, null, null, null, null, 6 },
                List.of(4, 5, 6, 3, 11));
        test &= test(new Integer[] { 2, 7, 5, 2, 6, null, 9, null, null, 5, 11, 4, null }, List.of(2, 5, 6, 4, 9));
        test &= test(new Integer[] { 1, 2, 3, 4, 10, 9, 11, -1, 5, null, null, null, null, null, null, null },
                List.of(4, 5, 6, 3, 11));
        System.out.println("============================");
    ...
    private static boolean test(Integer[] input, List<Integer> expected) {
        ...
        System.out.println(
                "outputLevelOrder : " + outputLevelOrder + " resultUsingLevelOrder : " + resultUsingLevelOrder);
    ...
    static class SolutionUsingLevelOrder {
        ...
        public List<Integer> bottomSideView(TreeNode root) {
             ...
             * Unlike HashMap and LinkedHashMap, TreeMap does not preserve the insertion
             * order.
             * Instead, it orders its entries based on the natural ordering of the keys, or
             * by a Comparator provided at map creation time.
             * When you iterate over the entries of a TreeMap, they are returned in
             * ascending order of their keys, according to the natural ordering or the
             * Comparator
             */
