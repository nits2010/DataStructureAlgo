package DataStructureAlgo.Java.LeetCode2025.ProblemSet.DynamicProgramming.stockPrices._714;

import DataStructureAlgo.Java.LeetCode2025.ProblemSet.DynamicProgramming.stockPrices._122.BestTimeToBuyAndSellStockII_122;
...
public class BestTimeToBuyAndSellStockWithTransactionFeeVI_714 {
    ...
    private static boolean test(int[] prices, int fee, int expected) {
        //add print here
        CommonMethods.printTest(new String[]{"Prices", "Fee", "Expected"}, true, prices, fee, expected);
        ...
        pass = output == expected;
        finalPass &= pass;
        CommonMethods.printTest(new String[]{"BottomUpV2", "Pass"}, false, output, pass ? "Pass" : "Fail");
        ...
        pass = output == expected;
        finalPass &= pass;
        CommonMethods.printTest(new String[]{"BottomUpV2-SpaceOptimized", "Pass"}, false, output, pass ? "Pass" : "Fail");
