package DataStructureAlgo.Java.LeetCode2025.ProblemSet.List._61;

import DataStructureAlgo.Java.LeetCode2025.ProblemSet.List._19.RemoveNthNodeFromEndOfList_19;
...
public class RotateList_61 {
    ...
    private static boolean test(Integer[] input, int k, Integer[] expected) {
        ...
        System.out.println(" Output :" + CommonMethods.print(output) + " Result match : " + result);
