 ...
 * -----------
 * Duplicate {@link}
 * Similar {@link DataStructureAlgo.Java.LeetCode2025.medium.stacks.NextGreaterElement.NextGreaterElementII_503}
 * extension {@link }
 * <p>
 *
 * Tags
...
class RemoveNodesFromLinkedList {
    ...
    /**
     * T/S: O(n)/O(2n)
     * Compute nge using {@link DataStructureAlgo.Java.LeetCode2025.medium.stacks.NextGreaterElement.NextGreaterElementII.SolutionUsingStack3Scans#nextGreaterElementsOnRight(int[], int[])}
    ...
    static class SolutionUsingStacksTwoScans {
        ...
        /**
         * T/S: O(n)/O(2n)
         * {@link DataStructureAlgo.Java.LeetCode2025.medium.stacks.NextGreaterElement.NextGreaterElementII.SolutionUsingStack3Scans#nextGreaterElementsOnRight(int[], int[])}
         *
         * @param head
         * @return
         */
