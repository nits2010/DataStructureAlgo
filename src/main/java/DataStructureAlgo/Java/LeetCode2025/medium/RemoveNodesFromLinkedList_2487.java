 ...
 * -----------
 * Duplicate {@link}
 * Similar {@link DataStructureAlgo.Java.LeetCode2025.medium.NextGreaterElement.NextGreaterElementII_503}
 * extension {@link }
 * <p>
 *
 * Tags
...
class RemoveNodesFromLinkedList {
    ...
    static class SolutionUsingStacksTwoScans {
        ...
        /**
         * T/S: O(n)/O(2n)
         * {@link DataStructureAlgo.Java.LeetCode2025.medium.NextGreaterElement.NextGreaterElementII.SolutionUsingStack3Scans#nextGreaterElementsOnRight(int[], int[])}
         *
         * @param head
         * @return
         */
