 ...
 * 2. Start generating next higher permutation. Do it until the next higher permutation is not possible. If we reach a permutation where all characters are sorted in non-increasing order,
 ...
 * 2. Now find the ceiling of the ‘first character.’ Ceiling is the smallest character on the right of ‘first character,’ which is greater than ‘first character.’ Let us call the ceil character as ‘second character’.
