...
public class BinaryTreeToList {
    ...
    private static void testSingly(TreeNode root, List<Integer> expected) {
        ...
        System.out.println(" \n Singly " + CommonMethods.print(listHead));
...
//        System.out.println(" \n Input " + Printer.preOrder(root) + " expected :" + expected);
        ...
        System.out.println(" \n Doubly " + CommonMethods.print(listHead));
    }
...
//        System.out.println(" \n Input " + Printer.preOrder(root) + " expected :" + expected);
        ...
        System.out.println(" \n Singly Circular" + CommonMethods.printCircular(listHead));
    }
    ...
    private static void testCircularDoubly(TreeNode root, List<Integer> expected) {
        ...
        System.out.println(" \n Doubly Circular" + CommonMethods.printCircular(listHead));
    }
