package DataStructureAlgo.Java.LeetCode.matrixPrint.dignoal.forward.downward;
 ...
 * Author: Nitin Gupta
 * Date: 23/09/19
 * Question Title: Diagonal Matrix Downward Right
 * Link: https://leetcode.com/problems/diagonal-matrix-downward-right/
 * Description:
 * Description:
 * Matrix:
 * [1,2,3]
