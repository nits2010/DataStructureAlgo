 ...
 * Author: Nitin Gupta
 * Date: 2019-08-31
 * Question Title: Longest Substring At Most K Distinct Characters
 ...
 * <p>
 * This is same question {@link DataStructureAlgo.Java.companyWise.Google.LongestSubStringKUniqueChar}
 * [Amazon]
 * File reference
 * -----------
 * Duplicate {@link}
...
public class LongestSubstringAtMostKDistinctCharacters {
    ...
    /**
     * O(n)/O(1)
     * Apply the same logic as {@link DataStructureAlgo.Java.companyWise.Google.LongestSubStringKUniqueChar}
