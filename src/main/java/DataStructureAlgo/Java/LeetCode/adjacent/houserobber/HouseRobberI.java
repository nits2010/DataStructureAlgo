...
public class HouseRobberI {
    ...
    private static void test(int[] nums, int expected) {
        ...
        HouseRobber.MaximumSumNoTwoElementsAreAdjacentRecursive recursive = new HouseRobber.MaximumSumNoTwoElementsAreAdjacentRecursive();
        HouseRobber.MaximumSumNoTwoElementsAreAdjacentDPTopDown dpTopDown = new HouseRobber.MaximumSumNoTwoElementsAreAdjacentDPTopDown();
        HouseRobber.MaximumSumNoTwoElementsAreAdjacentDPBottomUp bottomUp = new HouseRobber.MaximumSumNoTwoElementsAreAdjacentDPBottomUp();
        HouseRobber.MaximumSumNoTwoElementsAreAdjacentLinear linear = new HouseRobber.MaximumSumNoTwoElementsAreAdjacentLinear();

        System.out.println("recursive -> " + recursive.rob(nums));
        System.out.println("dpTopDown -> " + dpTopDown.rob(nums));
        System.out.println("bottomUp -> " + bottomUp.rob(nums));
        System.out.println("linear -> " + linear.rob(nums));
    }
}
...
class HouseRobber {
     ...
     */
    static class MaximumSumNoTwoElementsAreAdjacentRecursive {
     ...
     */
    static class MaximumSumNoTwoElementsAreAdjacentDPTopDown {
        public int rob(int[] nums) {
            return maximumSumNoTwoElementAreAdj(nums);
        }
     ...
     * Complexity : O(n)/ O(n)
     */
    static class MaximumSumNoTwoElementsAreAdjacentDPBottomUp {
        public int rob(int[] nums) {
            return maximumSumNoTwoElementAreAdj(nums);
        }
     ...
     */
    static class MaximumSumNoTwoElementsAreAdjacentLinear {
