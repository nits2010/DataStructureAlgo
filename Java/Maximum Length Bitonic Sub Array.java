...
class MLBitonicSA{
	...
	public boolean MaximumLengthBitonicSubarray(int input[]){
		if ( input.length == 0)
			return false; 
...
class Ideone
{
	public static void main (String[] args) throws java.lang.Exception
	{
		...
		if ( item.MaximumLengthBitonicSubarray(input) ) {
			item.print();
		...
		if ( item.MaximumLengthBitonicSubarray(input2) ) {
			item.print();
			System.out.println(" start : " +item.getI() + " end : "+item.getJ() + " length: "+item.getLength());
		}else{item.print();
			System.out.println("Not found");
		...
		if ( item.MaximumLengthBitonicSubarray(input3) ) {
			item.print();
			System.out.println(" start : " +item.getI() + " end : "+item.getJ() + " length: "+item.getLength());
		}else{item.print();
			System.out.println("Not found");
		...
		if ( item.MaximumLengthBitonicSubarray(input4) ) {
			item.print();
			System.out.println(" start : " +item.getI() + " end : "+item.getJ() + " length: "+item.getLength());
		}else{item.print();
			System.out.println("Not found");
		...
		if ( item.MaximumLengthBitonicSubarray(input5) ) {
			item.print();
			System.out.println(" start : " +item.getI() + " end : "+item.getJ() + " length: "+item.getLength());
		}else{
			item.print();
