...
public class WordBreakII {
    ...
    private static void test(String str, List<String> dict) {
        ...
        System.out.println(WordBreakIIBruteForce.wordBreak(str, dict));

        System.out.println("DFS Force\n");
        System.out.println(WordBreakIIDPDFS.wordBreak(str, dict));

        System.out.println("DP Force\n");
        System.out.println(WordBreakIIDP.wordBreak(str, dict));

        System.out.println("DP Optimized\n");
        System.out.println(WordBreakIIDPOptimized.wordBreak(str, dict));
    }
}

//O(2^n)
class WordBreakIIBruteForce {
...
class WordBreakIIDP {
    ...
    public static List<String> wordBreak(String s, List<String> wordDict) {
        ...
        if (s.length() == 0 || !canBreak(s, wordDict)) return new ArrayList<>();
