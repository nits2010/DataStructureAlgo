...
public class UniquePathsIII {
    ...
    private static void test(int[][] maze, int expected) {
        ...
        UniquePathsIIIBacktracking backtracking = new UniquePathsIIIBacktracking();
        UniquePathIIIDPTopDown pathIIDPTopDown = new UniquePathIIIDPTopDown();
        UniquePathsIIIDPBottomUp pathsIIDPBottomUp = new UniquePathsIIIDPBottomUp();
 ...
 * <p>
 */
class UniquePathsIIIDPBottomUp {
